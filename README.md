...
✔ Integração com SQL Server e MySQL
...
- 💙 Desenvolvendo aplicações utilizando **C# e .NET**
- 📖 Aprimorando conhecimentos em **ASP.NET Core**, **Entity Framework** e **Arquitetura de Software**
- 🚀 Compartilhando projetos e evolução contínua aqui no GitHub
